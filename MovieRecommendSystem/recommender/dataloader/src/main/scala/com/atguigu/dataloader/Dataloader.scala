...
object DataLoader {
  ...
  val MOVIE_DATA_PATH = "/Users/jacquelin/IdeaProjects/MovieRecommendSystem/recommender/dataloader/src/main/resources/movies.csv"
  val RATING_DATA_PATH = "/Users/jacquelin/IdeaProjects/MovieRecommendSystem/recommender/dataloader/src/main/resources/ratings.csv"
  val TAG_DATA_PATH = "/Users/jacquelin/IdeaProjects/MovieRecommendSystem/recommender/dataloader/src/main/resources/tags.csv"
  ...
  def main(args: Array[String]): Unit = {
    ...
    val config = Map(
      ...
      "es.httpHosts" -> "172.16.104.13:9200",
      "es.transportHosts" -> "172.16.104.13:9300",
  ...
  def storeDataInES(movieDF: DataFrame)(implicit esConfig: ESConfig): Unit = {
    ...
    val REDEX_HOST_PORT="(.+):(\\d+)".r
    esConfig.transportHosts.split(",").foreach{
      case REDEX_HOST_PORT(host:String,port:String)=>{
